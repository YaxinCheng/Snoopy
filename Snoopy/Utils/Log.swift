...
enum Log {
    ...
    static func notice(_ message: String, file: String = #fileID, function: String = #function, line: Int = #line) {
        logger.notice("\(message) -- [\(file):\(line) - \(function)]")
    }
    
    /// Logs an error message, optionally including an Error object. (Persisted by default).
    static func error(_ message: String, error: Error? = nil, file: String = #fileID, function: String = #function, line: Int = #line) {
    ...
    static func fault(_ message: String, file: String = #fileID, function: String = #function, line: Int = #line) -> Never {
